...
const FEATURES = [
  {
    ...
    description: "Gemini 2.5 Flash läser ditt CV, extraherar kompetenser, certifikat och erfarenheter automatiskt.",
    icon: (
  ...
  {
    title: "Semantisk matchning",
    description: "768-dimensionella vektorembeddings med pgvector ger djupare matchningar än nyckelordssökning.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: "Ett CV — fyra länder. Bilingual anchoring översätter dina kompetenser mellan svenska, norska och engelska.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Gap-analys",
    description: "Vi visar vilka formella krav du uppfyller — och vilka du saknar — för varje jobb.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main className="min-h-screen bg-surface-0 relative overflow-hidden">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24 text-center animate-fade-in">
        ...
        <p className="text-lg md:text-xl text-neutral-400 max-w-2xl mx-auto leading-relaxed mb-10">
          ...
          översätter dina kompetenser, analyserar certifikat och matchar dig
          direkt mot lediga jobb i hela Norden.
        </p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          >
            {user ? "Ladda upp CV" : "Skapa konto — gratis"}
          </Link>
          {!user && (
            <Link
              href="/login"
